...
- [ ] **Step 1: Write the failing test for BR formatters**
...
- [ ] **Step 4: Run BR format tests**

Run: `pytest tests/unit/utils/test_br_format.py -v`
Expected: 5 tests PASS.

- [ ] **Step 5: Write `theme.py`** (constants — no test needed; visual)
...
- [ ] **Step 1: Write `currency_input.py`**
...
- [ ] **Step 2: Write `amortization_table.py`**
...
- [ ] **Step 1: Write `app/utils/logger.py`** (loguru setup, spec §9.4)
...
- [ ] **Step 3: Apply migrations + seed first**
...
- [ ] **Step 1: Write smoke test using the NiceGUI User fixture**
...
- [ ] `python -m app.main` opens a desktop window, login works, all 10 tabs are reachable for the right perfis
- [ ] BR formatters round-trip correctly
- [ ] Simulation page produces correct charts and KPI values matching service output
- [ ] Comparativo, Amortização, Indicadores, Configurações pages functional
- [ ] Smoke test passes (`test_login_page_renders`)
- [ ] `ruff check app/ui/` clean
